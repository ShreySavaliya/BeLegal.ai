...
if "messages" not in st.session_state.keys():
    st.session_state.messages = [{"role": "assistant", "content": "I am your legal assistant. So how can I help you?"}]
...
llm = ChatGroq(model='mixtral-8x7b-32768', temperature=0.5, max_tokens=1024, groq_api_key='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')
